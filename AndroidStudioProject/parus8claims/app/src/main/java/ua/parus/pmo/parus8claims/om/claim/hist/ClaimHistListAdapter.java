package ua.parus.pmo.parus8claims.om.claim.hist;
...
public class ClaimHistListAdapter extends BaseAdapter {
    ...
    private static final String PARAM_PRN = "PPRN";
    ...
    public ClaimHistListAdapter(Context context, long prn) throws MalformedURLException {
        ...
        historyRequest.addHeaderParam(PARAM_SESSION, ((ClaimApplication) this.context.getApplicationContext()).getSessionId());
        historyRequest.addHeaderParam(PARAM_PRN, String.valueOf(prn));
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (lRow == null) {
            ...
            int layoutResourceId = R.layout.history_list_item;
